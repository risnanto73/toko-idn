                ...
                <table id="add-row" class="display table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($pesan->status == 3)
                                <span class="badge bg-primary" style="font-size: 12px;"><i class="fas fa-check"> Dikrim</i></span>
                                @endif
                            </td>
                            <td>
                            <div class="form-button-action">
                                    <button type="button" title="Edit" class="btn btn-link btn-primary btn-lg btn-round" data-original-title="Edit Task" data-toggle="modal" data-target="#updateLunas{{$pesan->id}}">
                                        <i class="fa fa-edit"></i>
                                    </button>
                                    @include('user.modal.update-lunas')
                                </div>
                            </td>
                        </tr>
                        @endforeach
