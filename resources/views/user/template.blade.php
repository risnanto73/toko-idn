...
<head>
	...
	<link rel="icon" href="{{asset('atlantis/assets/img/icon.ico" type="imag')}}e/x-icon" />
...
<body>
	...
	<!-- Sweet Alert -->
	<script src="{{asset('atlantis/assets/js/plugin/sweetalert/sweetalert.min.j')}}s"></script>
