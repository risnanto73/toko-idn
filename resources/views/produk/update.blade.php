									...
									<div class="form">
										<div class="form-group form-show-notify row">
											...
											<div class="col-lg-4 col-md-9 col-sm-8">
												<input type="text" value="{{$produk->nama_produk}}" name="nama_produk" class="form-control input-fixed" id="exampleInputPassword1">
											</div>
										</div>
										<div class="form-group form-show-notify row">
											<div class="col-lg-3 col-md-3 col-sm-4 text-right">
											...
											<div class="col-lg-4 col-md-9 col-sm-8">
												<input type="text" value="{{$produk->harga}}" name="harga" class="form-control input-fixed" id="exampleInputPassword1">
											</div>
										</div>
										<div class="form-group form-show-notify row">
											<div class="col-lg-3 col-md-3 col-sm-4 text-right">
											...
											<div class="col-lg-4 col-md-9 col-sm-8">
												...
												<select class="@error('kategori_id') is-valid @enderror form-control input-fixed" name="kategori_id">
													...
													<option value="{{$isi->id}}" @if($isi->id == $produk->kategori_id) selected="selected" @endif >{{$isi->nama_kategori}}</option>
													@endforeach
												</select>
											</div>
										</div>
										<div class="form-group form-show-notify row">
											...
											<div class="col-lg-4 col-md-9 col-sm-8">
												<select class="@error('kategori_id') is-valid @enderror form-control input-fixed" name="sedia">
													...
													<option value="Tersedia" selected>Tesedia</option> >Tesedia</option>
										...
										<div class="form-group form-show-notify row">
											...
											<div class="col-lg-4 col-md-9 col-sm-8">
												<input type="text" value="{{$produk->berat}}" name="berat" class="form-control input-fixed" id="exampleInputPassword1">
											</div>
										</div>
										<div class="form-group form-show-notify row">
											<div class="col-lg-3 col-md-3 col-sm-4 text-right">
											...
											<div class="col-lg-4 col-md-9 col-sm-8">
												<input type="file" value="{{$produk->gambar}}" name="gambar">
											</div>
										</div>
									</div>
								</div>
